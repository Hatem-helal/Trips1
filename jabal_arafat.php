...
<head>
  ...
  <style>
    body { background: #f3f0e7; font-family: 'Tajawal', sans-serif; padding: 30px; margin: 0; }
    .trip-box { background: #fff; padding: 25px; border-radius: 15px; max-width: 700px; margin: auto; box-shadow: 0 5px 15px rgba(0,0,0,0.1); }
    ...
    .back { display: block; margin-top: 25px; text-align: center; color: #8b6d35; text-decoration: none; font-size: 15px; }
...
<div class="trip-box">
  ...
  <a href="Trips.php" class="back">← العودة إلى جدول الرحلات</a>
</div>
